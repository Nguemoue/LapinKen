...
@section('main')
<h1 class="text-center shadow mx-4 p-2 bg-gradient my-3 text-uppercase" style="text-shadow: -1px -1px 1px black">Ajout D'un Nouveau Lapin</h1>
<hr>
        ...
        <div class="row">
            <div class="col col-7">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.lapins.store') }}" method="POST" class="row" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="col col-5 border py-2">
                <img src="#" class="img img-fluid img-thumbnail my-2 d-block" alt="Photo 1 du lapin" id="photo1">
                <img src="#" class="img img-fluid img-thumbnail my-2 d-block" alt="Photo 2 du lapin" id="photo2">
